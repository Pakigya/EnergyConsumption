...
public class SpatialExample
{
    ...
    public static final void main(String args[]) throws Exception {
        ...
        System.out.println(Phidget.getLibraryVersion());//this returns the version of the phidget type


        spatial = new SpatialPhidget();//spatical is a new object
